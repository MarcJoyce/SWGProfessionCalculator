...
export const ALL_PROFESSIONS = {
  ...
  crafting_industrialist: {
    master_links: [],
    master: "crafting_industrialist_master",
    branch_1: {
      links: [],
      skills: [
        "crafting_industrialist_housing_01",
        "crafting_industrialist_housing_02",
        "crafting_industrialist_housing_03",
        "crafting_industrialist_housing_04",
      ],
    },
    branch_2: {
      links: [],
    ...
    novice: "crafting_industrialist_novice",
    novice_links: [
      "crafting_artisan",
    ],
  },
  ...
  crafting_angler: {
    master_links: [],
    master: "crafting_angler_master",
    branch_1: {
      links: [],
      skills: [
        "crafting_angler_rivercraft_01",
        "crafting_angler_rivercraft_02",
        "crafting_angler_rivercraft_03",
        "crafting_angler_rivercraft_04",
      ],
    },
    branch_2: {
      links: [],
  ...
  pilot_rebel_navy: {
    master_links: [],
    master: "pilot_rebel_navy_master",
    branch_1: {
      links: [],
      skills: [
    ...
    novice: "pilot_rebel_navy_novice",
    novice_links: [],
  },
  pilot_imperial_navy: {
    master_links: [],
    master: "pilot_imperial_navy_master",
    branch_1: {
      links: [],
      skills: [
    ...
    novice: "pilot_imperial_navy_novice",
    novice_links: [],
  },
  pilot_neutral: {
    master_links: [],
    master: "pilot_neutral_master",
    branch_1: {
      links: [],
      skills: [
